export default {
  ...
  home: {
    ...
    features: {
      ...
      qualityTitle: '多种清晰度',
      qualityDesc: '在平台与原视频提供的范围内选择清晰度，最高可达 1080p / 2160p 或更高（视源而定）。',
      aiTitle: 'AI 视频总结',
    ...
    pricing: {
      ...
      vipPriceUnit: '/月起',
      vipPriceNote: '四档可选',
      vipF1: '最高 1080p / 2160p 等（视平台与源视频）',
      vipF2: '每天 50 次 AI 总结',
      vipF3: '批量下载与历史记录',
      vipF4: '3 并发 + 优先队列',
    ...
    faq: {
      ...
      q2: '可以下载更高清晰度吗？',
      a2: '免费用户限制为 720p；会员可下载平台与原视频提供的最高可用清晰度（如 1080p、2160p 等），实际取决于源视频与平台。',
      q3: 'AI 视频总结如何工作？',
  ...
  pricing: {
    ...
    dash: '—',
    freeQuality: '720p',
    vipQuality: '最高支持 1080p / 2160P / 更高清晰度（视平台与原视频可用格式而定）',
    freeAi: '3 次 / 天',
    vipAi: '50 次 / 天',
    freeChat: '每总结 5 轮',
    vipChat: '不限',
  ...
  account: {
    ...
    chatUnlimited: '不限',
    chatPerTask: '每总结 {n} 轮',
    resolutionUnlimited: '按平台原视频可用格式（含高清晰度）',
