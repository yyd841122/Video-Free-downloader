export default {
  ...
  home: {
    ...
    aiLoginInline: '请先登录后使用 AI 总结 MVP（平台字幕或上传 SRT/VTT）。',
    ...
    aiSummaryComingSoon:
      'AI 总结 MVP 当前已开放：支持上传 SRT/VTT 字幕，或有平台字幕的视频可尝试总结。无字幕自动转文字暂未开放。',
    aiResummary: '重新总结',
    ...
    aiSummaryHint:
      'AI 总结 MVP 已开放：优先使用平台字幕；暂无字幕时可上传 SRT/VTT 生成摘要、字幕文本、思维导图与问答。无字幕自动转文字暂未开放。',
    subtitleStatusAvailable: '字幕状态：已检测到字幕，可使用 AI 总结。',
    subtitleStatusUnavailable:
      '字幕状态：暂未检测到字幕。你可以上传 SRT / VTT 字幕文件继续生成 AI 总结；无字幕自动转文字暂未开放。',
    ...
    noTranscript:
      '该视频暂无可用字幕。无字幕自动转文字暂未开放；你也可以上传 SRT / VTT 字幕文件继续生成 AI 总结。',
    noTranscriptAsrFailed:
      '该视频暂无可用字幕，语音转写也未成功。你可以上传 SRT / VTT 字幕文件继续生成 AI 总结。',
    aiSubtitleAccessError:
      '当前视频暂未提取到可用字幕，或平台需要登录验证。无字幕自动转文字暂未开放；你也可以上传 SRT / VTT 字幕文件继续生成 AI 总结。',
    ...
    features: {
      ...
      aiTitle: 'AI 视频总结（MVP）',
      aiDesc:
        'AI 总结 MVP 已开放：支持上传 SRT/VTT 生成摘要、字幕文本、思维导图与问答；有平台字幕的视频可尝试直接总结。无字幕自动转文字暂未开放。',
    },
    pricing: {
      title: '选择适合你的方案',
    ...
    faq: {
      title: '常见问题',
      subtitle: '了解 SaveAny 的使用范围、当前能力与已知限制',
      q1: 'SaveAny 支持哪些平台？',
      ...
      q3: 'AI 视频总结怎么用？',
      a3:
        'AI 总结 MVP 已开放：支持上传 SRT/VTT 字幕生成摘要、字幕文本、思维导图与问答；有平台字幕的视频可尝试直接总结。无字幕自动转文字暂未开放。会员可优先使用并享有更高额度。',
      q4: '会员是订阅自动续费吗？',
  ...
  auth: {
    ...
    loginSubtitle: '用邮箱登录后可购买会员、查看订单，并使用 AI 总结 MVP',
    loginSubmit: '登录',
    loginSubmitting: '登录中…',
    loginFailed: '登录失败',
    loginRequired: '请输入邮箱与密码',
    registerTitle: '注册新账号',
    registerSubtitle: '注册免费用户即可使用 720p 下载与 AI 总结 MVP（平台字幕或上传字幕）',
  ...
  pricing: {
    ...
    mockModeTip: '本地开发环境：使用内置收银页验证会员流程，不产生真实扣款。',
    stripeTestModeTip:
      '当前网站内支付仍处于 Stripe Test Mode，仅用于内测验证，不代表正式扣款。',
    betaPaymentNotice:
      'Beta 期间如需开通会员，请通过人工方式开通，不要在站内 Test Mode 中误以为已完成真实付款。',
    betaManualActivationPrefix: '请联系 ',
    betaManualActivationSuffix: ' 申请人工开通会员。',
    loadFailed: '套餐加载失败',
    loading: '套餐加载中…',
  ...
  account: {
    ...
    vip: '会员',
    freeUser: '免费用户',
    vipSourceManual: '会员来源：人工开通 / 线下收款（MAN 订单）',
    vipSourceStripeTest: '会员来源：Stripe Test Mode 内测演示订单（非真实扣款）',
    vipSourceMixed: '会员来源：含人工开通与 Test Mode 演示订单；真实 Beta 付费以 MAN 人工订单为准。',
    vipBenefitsBoundary:
      '当前会员权益包括：高清下载、批量任务、AI 总结额度。AI 总结当前主要支持平台可提取字幕或上传 SRT/VTT 字幕；无字幕自动转文字 ASR 暂未开放。',
    ...
    quotaAiToday: 'AI 总结',
    quotaAiBeta: 'MVP（平台字幕 / 上传字幕）',
    orderDevCheckoutTag: '开发收银',
    orderManualGrantTag: '人工开通',
    orderStripeTestTag: 'Test Mode',
    orderManualGrantNote: '线下收款 / 管理员手动开通',
  ...
  payment: {
    mockTag: '开发环境收银',
    mockTitle: '本地开发收银页',
    mockDesc: '仅本地开发环境使用，用于验证会员开通流程，不会产生真实扣款。线上内测请使用 Stripe Test Mode。',
    ...
    reorder: '重新下单',
    stripeTip: '开发者提示：生产内测使用 Stripe Test Mode；本地 Mock 仅用于 MOCK_PAYMENT=true 的开发环境。',
    ...
    cancelBetaNote: '当前站内 Stripe 为 Test Mode 内测验证，不代表正式扣款。',
    cancelBetaContactPrefix: 'Beta 期间如需真实开通会员，请联系 ',
    cancelBetaContactSuffix: ' 申请人工开通。',
    viewMyOrders: '查看我的订单',
    backPricing: '返回套餐页',
    backHomeShort: '回到首页',
  },
