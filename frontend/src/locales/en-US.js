export default {
  ...
  home: {
    ...
    features: {
      ...
      qualityDesc: 'Choose quality within what the platform and source offer — up to 1080p / 2160p or higher when available.',
    ...
    pricing: {
      ...
      vipF1: 'Up to 1080p / 2160p, etc. (platform & source)',
    ...
    faq: {
      ...
      a2: 'Free users are limited to 720p. VIP can download the highest quality the platform and source offer (e.g. 1080p, 2160p), depending on the video.',
  ...
  pricing: {
    ...
    dash: '—',
    freeQuality: '720p',
    vipQuality: 'Up to 1080p / 2160P / higher quality when available, depending on the platform and source video.',
    freeAi: '3 / day',
    vipAi: '50 / day',
  ...
  account: {
    ...
    resolutionUnlimited: 'Per platform & source (incl. HD when offered)',
