export default {
  ...
  home: {
    ...
    aiLoginInline: 'Log in to use AI summaries.',
    ...
    pricing: {
      ...
      subtitle: 'Free for daily use; VIP unlocks higher quality (when the platform and source offer it), more AI runs, batch download, and priority queue',
      freeName: 'Free',
