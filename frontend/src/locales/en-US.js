export default {
  ...
  home: {
    ...
    aiLoginInline: 'Please log in to use AI Summary MVP (platform subtitles or uploaded SRT/VTT).',
    ...
    aiSummaryComingSoon:
      'AI Summary MVP is available: upload SRT/VTT subtitles, or try videos with extractable platform subtitles. Auto transcription for videos without subtitles is not available yet.',
    ...
    aiSummaryHint:
      'AI Summary MVP is available: platform subtitles are used first; upload SRT/VTT for summary, transcript, mind map, and Q&A. Auto transcription for videos without subtitles is not available yet.',
    subtitleStatusAvailable: 'Subtitle status: Subtitles detected. AI summary is available.',
    subtitleStatusUnavailable:
      'Subtitle status: No subtitles detected. You can upload an SRT/VTT subtitle file to generate a summary. Auto transcription is not available yet.',
    ...
    noTranscript:
      'No usable subtitles were found for this video. Auto transcription is not available yet. You can upload an SRT/VTT subtitle file to continue AI summary.',
    ...
    aiSubtitleAccessError:
      'No usable subtitles could be extracted, or the platform requires login verification. Auto transcription is not available yet. You can upload an SRT/VTT subtitle file to continue.',
    ...
    features: {
      ...
      aiTitle: 'AI video summary (MVP)',
      aiDesc:
        'AI Summary MVP is available for uploaded SRT/VTT subtitles and videos with extractable platform subtitles. Auto transcription for videos without subtitles is not available yet.',
    },
    pricing: {
      ...
      freeF2: 'AI Summary MVP (platform subs / upload)',
      ...
      vipF2: 'AI Summary MVP (VIP priority)',
    ...
    faq: {
      title: 'FAQ',
      subtitle: 'Usage, current capabilities, and known limits',
      ...
      a3:
        'AI Summary MVP is available for uploaded SRT/VTT subtitles and videos with extractable platform subtitles. Auto transcription for videos without subtitles is not available yet. VIP members get priority access and higher limits.',
  ...
  auth: {
    ...
    loginSubtitle: 'Sign in to purchase VIP, view orders, and use AI Summary MVP.',
    loginSubmit: 'Log in',
    loginSubmitting: 'Signing in…',
    loginFailed: 'Sign in failed',
    loginRequired: 'Please enter email and password',
    registerTitle: 'Create an account',
    registerSubtitle: 'Free tier includes 720p downloads and AI Summary MVP (platform subtitles or upload).',
  ...
  pricing: {
    ...
    mockModeTip: 'Local development: built-in checkout page to verify membership flow. No live charges.',
    stripeTestModeTip:
      'In-site payments are currently in Stripe Test Mode for Beta validation and do not represent live charges.',
    betaPaymentNotice:
      'During Beta, activate membership through manual activation. Do not treat in-site Test Mode checkout as a live payment.',
    betaManualActivationPrefix: 'Contact ',
    betaManualActivationSuffix: ' for manual membership activation.',
    ...
    freeAi: 'MVP (platform subs / upload)',
    vipAi: 'MVP priority + higher limits',
    freeChat: 'MVP (Q&A per summary)',
    vipChat: 'MVP priority',
    freeConcurrent: '1',
    vipConcurrent: '3',
    vipHistory: '✔',
    vipRedownload: '✔',
  ...
  account: {
    ...
    vip: 'VIP',
    freeUser: 'Free user',
    vipSourceManual: 'Membership source: manual activation / offline payment (MAN order)',
    vipSourceStripeTest: 'Membership source: Stripe Test Mode demo order (not a live charge)',
    vipSourceMixed:
      'Membership source: includes manual activation and Test Mode demo orders. Real Beta payments are MAN manual orders.',
    vipBenefitsBoundary:
      'Your membership includes HD downloads, batch tasks and AI summary quota. AI summary currently works best with extractable platform subtitles or uploaded SRT/VTT files. Auto transcription for videos without subtitles is not available yet.',
    ...
    quotaAiBeta: 'MVP (platform subs / upload)',
    orderDevCheckoutTag: 'Dev checkout',
    orderManualGrantTag: 'Manual grant',
    orderStripeTestTag: 'Test Mode',
    orderManualGrantNote: 'Offline payment / admin activation',
  ...
  payment: {
    mockTag: 'Dev checkout',
    mockTitle: 'Local development checkout',
    mockDesc:
      'For local development only. Used to verify membership activation. No live charges. Soft launch uses Stripe Test Mode in production.',
    ...
    labelAmount: 'Amount',
    labelStatus: 'Status',
    mockSuccess: 'Mark as paid',
    mockFail: 'Mark as failed',
    ...
    stripeTip:
      'Developer note: production soft launch uses Stripe Test Mode. Local mock checkout is only when MOCK_PAYMENT=true.',
    ...
    cancelBetaNote: 'In-site Stripe is in Test Mode for Beta validation and does not represent live charges.',
    cancelBetaContactPrefix: 'For real Beta membership, contact ',
    cancelBetaContactSuffix: ' for manual activation.',
